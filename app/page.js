...
export default function Home() {
    return (
        <main>
            ...
            <div className="grid grid-cols-1 px-10 py-10 md:grid-cols-2 md:px-15 md:py-5 gap-7 lg:grid-cols-2 lg:gap-4 lg:mx-40">
                <div>
                  <Image
                  src="/sad.jpg"
                  alt="sad"
                  width={350}
                  height={350} className="w-[350px] h-[350px] rounded-full my-3"
                  />
                </div>
                <div>
                    <Image
